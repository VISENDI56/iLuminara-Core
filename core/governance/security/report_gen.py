...
def generate_markdown_report():
    ...
    report_content = f"""# iLuminara Core: Technical Resilience Report
**Date:** {timestamp}
...
"""
    with open("documentation/reports/Resilience_Report_2026.md", "w") as f:
        f.write(report_content)
    print("[+] Resilience Report Generated: documentation/reports/Resilience_Report_2026.md")
